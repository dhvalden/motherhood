...
if __name__ == "__main__":
    run_isc('./data/byintensity/ii_t_5_hi.csv', './data/byintensity/ii_c_full.csv', 'ind_inc_deflated', 'hi5pt', 10, True)
    run_isc('./data/byintensity/ii_t_5_mhi.csv', './data/byintensity/ii_c_full.csv', 'ind_inc_deflated', 'mhi5pt', 10, True)
    run_isc('./data/byintensity/ii_t_5_mli.csv', './data/byintensity/ii_c_full.csv', 'ind_inc_deflated', 'mli5pt', 10, True)
    run_isc('./data/byintensity/ii_t_5_li.csv', './data/byintensity/ii_c_full.csv', 'ind_inc_deflated', 'li5pt', 10, True)

    run_isc('./data/byintensity/hhi_t_5_hi.csv', './data/byintensity/hhi_c_full.csv', 'hh_inc_deflated', 'hi5pt', 10, True)
    run_isc('./data/byintensity/hhi_t_5_mhi.csv', './data/byintensity/hhi_c_full.csv', 'hh_inc_deflated', 'mhi5pt', 10, True)
    run_isc('./data/byintensity/hhi_t_5_mli.csv', './data/byintensity/hhi_c_full.csv', 'hh_inc_deflated', 'mli5pt', 10, True)
    run_isc('./data/byintensity/hhi_t_5_li.csv', './data/byintensity/hhi_c_full.csv', 'hh_inc_deflated', 'li5pt', 10, True)
