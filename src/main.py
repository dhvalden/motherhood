...
if __name__ == "__main__":
    run_isc('./data/byintensity/ii_t_hi.csv', './data/byintensity/ii_c_full.csv', 'ind_inc_deflated', 'hi', 10, True)
    run_isc('./data/byintensity/ii_t_mhi.csv', './data/byintensity/ii_c_full.csv', 'ind_inc_deflated', 'mhi', 10, True)
    run_isc('./data/byintensity/ii_t_mli.csv', './data/byintensity/ii_c_full.csv', 'ind_inc_deflated', 'mli', 10, True)
    run_isc('./data/byintensity/ii_t_li.csv', './data/byintensity/ii_c_full.csv', 'ind_inc_deflated', 'li', 10, True)

    run_isc('./data/byintensity/hhi_t_hi.csv', './data/byintensity/hhi_c_full.csv', 'hh_inc_deflated', 'hi', 10, True)
    run_isc('./data/byintensity/hhi_t_mhi.csv', './data/byintensity/hhi_c_full.csv', 'hh_inc_deflated', 'mhi', 10, True)
    run_isc('./data/byintensity/hhi_t_mli.csv', './data/byintensity/hhi_c_full.csv', 'hh_inc_deflated', 'mli', 10, True)
    run_isc('./data/byintensity/hhi_t_li.csv', './data/byintensity/hhi_c_full.csv', 'hh_inc_deflated', 'li', 10, True)

    run_isc('./data/byintensity/is_t_hi.csv', './data/byintensity/is_c_full.csv', 'inc_share', 'hi', 10, True)
    run_isc('./data/byintensity/is_t_mhi.csv', './data/byintensity/is_c_full.csv', 'inc_share', 'mhi', 10, True)
    run_isc('./data/byintensity/is_t_mli.csv', './data/byintensity/is_c_full.csv', 'inc_share', 'mli', 10, True)
    run_isc('./data/byintensity/is_t_li.csv', './data/byintensity/is_c_full.csv', 'inc_share', 'li', 10, True)
